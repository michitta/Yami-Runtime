...
//        }
    ...
    private void sceneBaseInit() {
        LookupHelper.<ButtonBase>lookupIfPossible(layout, "#discord").ifPresent((b) -> b.setOnAction((e) -> application.openURL("https://discord.com/invite/zkgTtqzeXG")));
        LookupHelper.<ButtonBase>lookupIfPossible(layout, "#site").ifPresent((b) -> b.setOnAction((e) -> application.openURL("https://yami.town/")));
        LookupHelper.<ButtonBase>lookupIfPossible(layout, "#vk").ifPresent((b) -> b.setOnAction((e) -> application.openURL("https://vk.com/yami.town")));
        LookupHelper.<ButtonBase>lookupIfPossible(layout, "#cabinet").ifPresent((b) -> b.setOnAction((e) -> application.openURL("https://yami.town/cabinet/")));
        if (header == null) {
